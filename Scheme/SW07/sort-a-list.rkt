...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname sort-a-list) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
